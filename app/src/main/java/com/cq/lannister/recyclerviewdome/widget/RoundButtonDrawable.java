 ...
 * <li>使用 {@link #setIsRadiusAdjustBounds(boolean)} 设置圆角大小是否自动适应为View的高度的一半, 默认为 true。</li>
 * </ul>
 */
public class RoundButtonDrawable extends GradientDrawable {
    ...
    public static RoundButtonDrawable fromAttributeSet(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList colorBg = typedArray.getColorStateList(R.styleable.RoundButton_backgroundColor);
        ColorStateList colorBorder = typedArray.getColorStateList(R.styleable.RoundButton_borderColor);
        int borderWidth = typedArray.getDimensionPixelSize(R.styleable.RoundButton_borderWidth, 0);
        boolean isRadiusAdjustBounds = typedArray.getBoolean(R.styleable.RoundButton_isRadiusAdjustBounds, false);
        int mRadius = typedArray.getDimensionPixelSize(R.styleable.RoundButton_radius, 0);
        int mRadiusTopLeft = typedArray.getDimensionPixelSize(R.styleable.RoundButton_radiusTopLeft, 0);
        int mRadiusTopRight = typedArray.getDimensionPixelSize(R.styleable.RoundButton_radiusTopRight, 0);
        int mRadiusBottomLeft = typedArray.getDimensionPixelSize(R.styleable.RoundButton_radiusBottomLeft, 0);
        int mRadiusBottomRight = typedArray.getDimensionPixelSize(R.styleable.RoundButton_radiusBottomRight, 0);
        typedArray.recycle();
